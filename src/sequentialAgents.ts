...
export class PolicyA2AClientAgent extends BaseAgent {
  ...
  private readonly _a2aServerUrl: string = `http://localhost:${process.env.POLICY_AGENT_PORT || 4000}`;
...
const runner = new InMemoryRunner({ agent: rootAgent, appName: 'A2A Sample with Sequential Agent and ADK Agent Wrapped around A2A Client' });
